...
export const dummyProjects: Project[] = [
  ...
  {
    id: "8",
    title: "Event Management System - Eventra",
    status: "Completed",
    category: "web-app",
    description:
      "A premium event management SaaS demo for discovering events, selling tickets, managing attendees, and tracking organizer revenue.",
    fullDescription:
      "Eventra is a modern event management platform designed for both attendees and organizers. The demo includes event discovery, dynamic event detail pages, ticket selection, secure checkout UI, organizer dashboards, revenue tracking, attendee management, notifications, subscription-ready billing flows, and SEO-optimized sharing previews.",
    technologies: [
      "Next.js",
      "TypeScript",
      "Tailwind CSS",
    ...
    image: "https://akili-eventra.vercel.app/opengraph-image",
    liveUrl: "https://akili-eventra.vercel.app",
    githubUrl: "https://github.com/akilinova/eventra",
    gradient: "from-[#0d141d] via-[#1e1b4b] to-[#7C3AED]",
    timeline: "Portfolio Demo",
    teamSize: "Solo Developer",
    launchDate: "2026-05-01",
    challenges: [
      "Designing a SaaS-grade interface that works for both attendees and organizers",
      "Creating secure checkout flows without exposing pricing data in URLs",
      "Making event pages SEO-friendly with rich social sharing previews",
    ],
    solutions: [
      "Built a polished dark-themed UI with reusable components and responsive layouts",
      "Moved ticket pricing logic away from editable query parameters",
      "Added metadata, Open Graph images, favicon branding, and dynamic event previews",
    ],
    impact: [
      "Showcases AkiliNova’s ability to build premium SaaS products",
      "Demonstrates event discovery, ticketing, dashboards, billing, and SEO workflows",
      "Positions the product as a strong foundation for a real event management platform",
    ],
    stackExplanation: {
      frontend:
        "Next.js and TypeScript power the app structure, routing, SEO metadata, and dynamic event pages.",
      backend:
        "The current version is a frontend-focused demo using structured mock data, ready to be connected to a real API.",
      infrastructure:
        "Designed for deployment on modern hosting platforms like Vercel with Open Graph support and optimized static assets.",
    },
    keyFeatures: [
      "Event discovery and event detail pages",
      "Ticket selection and checkout flow",
      "Organizer dashboard",
      "Revenue and attendee management",
      "Dummy notifications and mobile navigation",
      "Subscription-ready billing UI",
      "SEO metadata and Open Graph previews",
    ],
    featured: true,
