...
export default function ServicesSection({
  ...
  return (
    <section
      className={`relative ${
        compactMode ? "py-12 lg:py-16" : "py-20 lg:py-28"
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {!compactMode && showDevelopmentProcess && (
          <div className="relative">
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-orange-50 via-white to-blue-50 rounded-3xl" />

            <div className="relative bg-white/80 backdrop-blur-sm rounded-3xl p-8 lg:p-12 border border-gray-200 shadow-xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                  {[
                    ...
                    <div key={index} className="relative text-center">
                      {/* Step Number */}
                      <div
                        className={`relative w-20 h-20 bg-gradient-to-br ${process.color} rounded-2xl flex items-center justify-center text-white font-bold text-2xl mb-6 mx-auto shadow-lg`}
                      >
                        <div className="absolute inset-0 bg-white/10 rounded-2xl" />
                      ...
                      {/* Step Content */}
                      <div className="px-4">
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-gray-100 text-gray-700 text-sm font-semibold mb-4">
                          Step {process.step}
                        </div>
              ...
              <div className="text-center mt-12 pt-8 border-t border-gray-100">
                ...
                <button className="group relative inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-orange-500 to-orange-600 text-white font-semibold rounded-xl hover:shadow-2xl hover:shadow-orange-500/25 transition-all duration-300 hover:-translate-y-0.5">
