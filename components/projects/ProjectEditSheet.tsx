...
export function ProjectEditSheet({
  ...
  useEffect(() => {
    if (project) {
      setFormData(project)
      // Reset required fields validation when project changes
      setRequiredFields({
        title: false,
        description: false,
        status: false,
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const cleanedData = {
      ...
      stackExplanation: formData.stackExplanation || {
        frontend: "",
        backend: "",
        infrastructure: "",
      },
                        ...
                        <Textarea
                          ...
                          onChange={(e) =>
                            setFormData({
                              ...formData,
                              stackExplanation: {
                                ...(formData.stackExplanation || { frontend: "", backend: "", infrastructure: "" }),
            ...
            <div className="flex items-center justify-between w-full">
              <div className="text-sm text-muted-foreground">
                {formData.updatedAt ? (
                  ...
                  <span>Tab {["basic", "details", "technical", "impact"].indexOf(activeTab) + 1} of 4</span>
                )}
              </div>
