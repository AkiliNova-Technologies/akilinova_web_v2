...
interface BlogCreateSheetProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  onSubmit: (blog: Omit<BlogPost, "id" | "createdAt" | "updatedAt" | "viewCount" | "likeCount" | "commentCount">) => void;
}
...
export function BlogCreateSheet({
  open,
  onOpenChange,
  onSubmit,
}: BlogCreateSheetProps) {
        ...
        <form onSubmit={handleSubmit}>
          <SheetHeader className="px-6 py-4 border-b">
            <div className="flex items-center justify-between">
              <div>
                <SheetTitle className="text-2xl font-bold">Create Blog Post</SheetTitle>
                <SheetDescription className="mt-1">
                  Create a new blog post with SEO optimization and rich content
                </SheetDescription>
              </div>
